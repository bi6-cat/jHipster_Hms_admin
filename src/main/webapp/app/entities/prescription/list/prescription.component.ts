...
import { EntityArrayResponseType, PrescriptionService } from '../service/prescription.service';
...
export class PrescriptionComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.prescriptions.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IPrescription[] | null): IPrescription[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.prescriptionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
