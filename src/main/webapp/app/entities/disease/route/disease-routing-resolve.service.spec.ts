...
import diseaseResolve from './disease-routing-resolve.service';

describe('Disease routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: DiseaseService;
  let resultDisease: IDisease | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IDisease returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        diseaseResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultDisease).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDisease>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
