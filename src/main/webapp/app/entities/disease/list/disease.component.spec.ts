...
import { sampleWithRequiredData } from '../disease.test-samples';
...
describe('Disease Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.diseases()[0]).toEqual(expect.objectContaining({ id: 23904 }));
  });

  describe('trackId', () => {
    it('should forward to diseaseService', () => {
      const entity = { id: 23904 };
      jest.spyOn(service, 'getDiseaseIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDiseaseIdentifier).toHaveBeenCalledWith(entity);
