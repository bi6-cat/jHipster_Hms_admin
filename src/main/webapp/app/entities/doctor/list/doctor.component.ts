...
import { DoctorService, EntityArrayResponseType } from '../service/doctor.service';
...
export class DoctorComponent implements OnInit {
  ...
  trackId = (item: IDoctor): number => this.doctorService.getDoctorIdentifier(item);
